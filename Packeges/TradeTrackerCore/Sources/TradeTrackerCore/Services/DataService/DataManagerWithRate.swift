...
public protocol DataManagerWithRateProtocol: TransactionDataManagerProtocol {
    func loadRates() -> Result<[RateData], DataServiceError>
}

public final class DataManagerWithRate: DataManagerWithRateProtocol {
    private let transactionDataManager: TransactionDataManagerProtocol
    private let dataLoader: DataLoaderProtocol

    public init(dataLoader: DataLoaderProtocol, transactionDataManager: TransactionDataManagerProtocol) {
